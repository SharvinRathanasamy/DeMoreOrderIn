...
<div class="rightcolumn">
 ...
 <br>
        <div class="search">
            <i class="fa fa-search"></i><input type="search" id="hissch" name="hissch" class="hissch" onkeyup="search()" placeholder="Search"><br><br>
      ...
      <form  method="POST">
        ...
        <select name="fill2" id="fill2" class="fill2"> 
          ...
          <select name="fill3" id="fill3" class="fill3"> 
			...
			<input type='hidden' name='s_id' id="s_id" value='<?php echo  $_s; ?>'>
        ...
        <div class="scrollbar" id="hist">
         <table>
            <thead>
                <tr class="header">
                    <th> BookingID&nbsp &nbsp &nbsp &nbsp &nbsp </th>
                    <th> Customer Name&nbsp &nbsp &nbsp &nbsp &nbsp  </th>
                    <th> Contact Number&nbsp &nbsp &nbsp &nbsp &nbsp  </th>
                    <th> Pick-up Date&nbsp &nbsp &nbsp &nbsp &nbsp  </th>
                    <th> Pick-up Time&nbsp &nbsp &nbsp &nbsp &nbsp  </th>
                    <th> Booking Status&nbsp &nbsp &nbsp &nbsp &nbsp  </th>
                    <th class="opencol"> </th>
                </tr>
            </thead>

            <?php include'homesch.php' ?>
...
<div class = "divul">
  <ul>
    <li><a href="addcust.php"><button class="button" role="button">Add Booking</button></a></li>
    <li><a href="staffprof.php"><button class="button" role="button">Edit Profile</button></a></li>
    <li><a href="a_log.php"><button class="button" role="button">Admin</button></a></li>
    <li><p>👋</p>
    </li>
  </ul>
</div>
